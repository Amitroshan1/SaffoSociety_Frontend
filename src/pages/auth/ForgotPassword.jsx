...
//               <motion.div
//                 key={step}
//                 className={`icon-wrapper ${step === 'done' ? 'icon-wrapper--done' : 'icon-wrapper--default'}`}
//                 initial={{ scale: 0.8, opacity: 0 }}
//                 animate={{ scale: 1, opacity: 1 }}
//                 transition={{ type: 'spring', stiffness: 200, damping: 15 }}
//               >
//                 <cfg.icon className="header-icon" />
//               </motion.div>
//               <h1 className="card-title">{cfg.title}</h1>
//               <p className="card-subtitle">{cfg.subtitle}</p>
//             </div>
...
//                   type="submit"
//                   disabled={loading}
//                   className="submit-btn submit-btn--violet"
...
//                   ) : (
//                     <span className="btn-inner">
//                       <Sparkles className="btn-icon" /> Send OTP
//                     </span>
//                   )}
//                 </motion.button>
//               </form>
...
//                   ) : (
//                     <span className="btn-inner">
//                       <Sparkles className="btn-icon" /> Reset Password
//                     </span>
//                   )}
//                 </motion.button>
//               </form>
...
//             {step === 'done' && (
//               <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
//                 <Link to="/login" className="submit-btn submit-btn--emerald">
//                   <Building2 className="btn-icon" /> Back to Login
//                 </Link>
//               </motion.div>
//             )}
//           </div>
